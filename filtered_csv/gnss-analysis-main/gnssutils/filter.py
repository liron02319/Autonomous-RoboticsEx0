...
# input_filepath = 'C:\\Users\\Batya Ashkenazi\\Downloads\\filtered_csv\\gnss-analysis-main\\data\\sample\\gnss_log_2024_04_13_19_51_17.txt'
input_filepath = 'C:\\Users\\Batya Ashkenazi\\Downloads\\filtered_csv\\gnss-analysis-main\\data\\sample\\gnss_log_2024_04_13_19_52_00.txt'
...
sv_position.to_csv('satellite_positions.csv', index=False)
...
# Keep only the first occurrence of each satellite PRN
# filtered_data = filtered_data.drop_duplicates(subset='SatPRN (ID)', keep='first')

# Save DataFrame to CSV
filtered_data.to_csv('filtered_plot_data.csv', index=False)
